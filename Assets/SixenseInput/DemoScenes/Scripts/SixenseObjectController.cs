...
public class SixenseObjectController : MonoBehaviour {
	...
	public Vector3				Sensitivity = new Vector3( 0.005f, 0.00f, 0.005f );
	...
	{
		/*Vector3 controllerPosition = new Vector3( controller.Position.x * 0,
                                                  //controller.Position.x * Sensitivity.y,
												  controller.Position.y * 0,
                                                  controller.Position.z * 0
                                                  //controller.Position.z * Sensitivity.z 
                                                  ); */
